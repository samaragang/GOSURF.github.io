...
<body>
    <header class="header">
        <div class="header__title">go<br>surf</div>
        <div class="header__arrows">
            <a href="#" class="animate__animated animate__fadeInDown animate__infinite animate__slow">
                <img src="assets/images/arrows-down.svg" alt="">
            </a>
        </div>
        ...
        <div class="header__aside">
            ...
            <nav class="menu">
                <ul class="menu__list">
                    <li>
                        <a href="">
                            <img src="assets/images/surf.svg" alt=""><span>Surf</span>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <img src="assets/images/travel.svg" alt=""><span>Travel</span>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <img src="assets/images/sleep.svg" alt=""><span>Sleep</span>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <img src="assets/images/shop.svg" alt=""><span>Shop</span>
                        </a>
                    </li>
                </ul>
            </nav>
        ...
        <div class="slider-dotshead animate__animated animate__fadeInUp delay-3s">
    ...
    <div class="page">
        <section class="surf">
            <div class="title">
                <div>
                   <span class="wow animate__animated animate__fadeInLeft" data-wow-offset="400">Surf</span> 
                    <h3>surf</h3>
                </div>
            </div>
            <div class="surf__subtitle">
                <div class="subtitle wow animate__animated animate__fadeInRight" data-wow-offset="400">
                    <div class="headline-left">Current locatian</div>
            ...
            <div class="slider-map wow animate__animated animate__zoomInDown" data-wow-duration="1.5s" data-wow-offset="350">

            <?php foreach ($resorts as $data) { ?>
                <div class="slider-dots  slider-dots--<?= $data['id'];?>">
                    <div class="slider-dots__circle animate__animated animate__fadeInUpBig"></div>                      
                    <div class="slider-dots__content animate__animated animate__fadeIn">
                        <div class="slider-dots__content-row">
                            <div class="slider-dots__content-head">
                                <div class="slider-dots__content-title"> <?= $data['title'];?> </div>
                                <div class="slider-dots__content-subtitle"><?= $data['country'];?></div>
                            </div>
            ...
            <?php foreach ($description as $data) { ?>
                <div class="surf-box">
                    <div class="surf-box__wrapper animate__animated animate__fadeInUp" style="background-image: url(assets/images/<?=$data['img'];?>.jpg);">
                    <div class="surf-box__inner">
                            <div class="surf-box__inner-title"><?= $data['title'];?></div>
                            <div class="surf-box__inner-location"><?= $data['city'];?> <span>|</span> <?= $data['country'];?></div>
         ...
         <section class="holder">
            ...
            <div class="holder__slider">
                <?php foreach ($airlines_JOIN_description as $data) {?>
                    <div class="holder__slider-item holder-slider">
                        <div class="holder-slider__head" style="background-image: url(assets/images/travelslider-bg.png);">
                            <div class="holder-slider__subtitle">
                                <div class="subtitle wow animate__animated animate__fadeInRight" data-wow-offset="400">
                                    ...
                                    <div class="subtitle__head"><?=$data['title'];?> <span>|</span> <?=$data['country'];?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="holder-slider__info">
                            <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay=".3s">
                                <div class="holder-slider__info-subtitle">Destination</div>
                                <div class="holder-slider__info-title"><?=$data['city'];?> <br><?=$data['country'];?></div>
                            </div>
                            <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay=".4s">
                                <div class="holder-slider__info-subtitle">Distance</div>
                                <div class="holder-slider__info-title"><?=$data['price'];?><br>Miles</div>
                            </div>
                            ...
                            <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay=".6s">
                                ...
                                <div class="holder-slider__info-title">$<?=$data['price'];?> USD 
        ...
        <section class="holder sleep">
                ...
                <div class="holder__slider">
                    <?php foreach ($hotel_JOIN_description as $data) {?>
                        <div class="holder__slider-item holder-slider">
                            <div class="holder-slider__head" style="background-image: url(assets/images/sleepslider-bg.png);">
                                <div class="holder-slider__subtitle">
                                    <div class="subtitle wow animate__animated animate__fadeInRight" data-wow-offset="400">
                                        ...
                                        <div class="subtitle__head"><?=$data['hotel'];?> <span>|</span> <?=$data['city'];?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="holder-slider__info">
                                <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay=".3s">
                                    ...
                                    <div class="holder-slider__info-title"><?=$data['hotel'];?> <br><?=$data['city'];?></div>
                                </div>
                                <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay=".6s">
                                ...
                                <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay=".9s">
                                ...
                                <div class="holder-slider__info-item wow animate__animated animate__fadeInUp" data-wow-offset="200" data-wow-delay="1.2s">
                                    <div class="holder-slider__info-subtitle">Pricing</div>
                                    <div class="holder-slider__info-title"> 
                            ...
                            <div class="shop__slider-inner">
                                <div class="shop__slider-info">
                                    <div class="descr">
                                        ...
                                        <div class="descr__head descr__head-shop"><?=$data['name'];?></div>
                                    </div>
